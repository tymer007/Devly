    ...
    <>
      ...
      <div className="flex">
        ...
        <div className="flex-1 p-4">
            <div className='font-extrabold font-mono text-2xl p-0 m-0'>Resume & Cards<span className='p-0 m-0 font-bold font-sans text-2xl'>_</span></div>
          
          <p>Fill your resume and download your resume and cards</p>
        </div>
      </div>
    </>
  );
