  ...
  return (
   <div className='w-full bg-white m-h-dvh flex '>
    ...
    <div className='bg-[#DDF7EB] w-[45.5rem]  h-dvh  md:h-dvh md:w-full '>
      <div className='w-10/12 h-auto  lg:w-9/12 bg-white  m-auto p-10 my-8 rounded-lg '>
      <p className="text-2xl font-bold  text-center mt-[1rem]">Login</p>
      <p className='text-center font-semibold mt-3'>Login into your account</p>
      <form className='mt-10'>
            <div className="mb-4">
              <label htmlFor="email" className="block text-sm font-medium text-gray-700 ml-4">Email Id :</label>
            ...
            <div>
              <button 
              type="submit" 
              className="w-[80%] m-auto  flex justify-center py-2 px-4 border border-transparent rounded-md shadow-lg text-sm font-medium text-white bg-[#0DA16C] hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">Login now</button>
            </div>
            <div className="mt-5 text-center flex items-center justify-center mb-6 gap-5">
              <div className='w-[40%] h-[0.05rem] bg-black'></div>
