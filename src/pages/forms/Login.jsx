        ...
        <Link to="/"><button className="flex items-center justify-center bg-[#0DA16C] text-white rounded-md hover:bg-teal-500">
          ...
          <form className='mt-10'>
            ...
            <div>
              <Link to="/"><button
                type="submit"
                className="w-[80%] m-auto  flex justify-center py-2 px-4 border border-transparent rounded-md shadow-lg text-sm font-medium text-white bg-devlyGreen hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">Login now</button></Link>
            </div>
            ...
            <div className="mt-4">
              <Link to="/SignUp"><button
                type="button"
                className="w-[80%] m-auto flex justify-center py-2 px-4 border-2 border-[#0DA16C] rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">Signup now</button></Link>
            </div>
          </form></div>
      </div>
    </div>
