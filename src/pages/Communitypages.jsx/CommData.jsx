...
const CommData = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://connect-i645.onrender.com/api/connect/portfolio/portfolio/dataScience');
  ...
  return (
    <div>
      ...
      <div className="pt-10 font-bold text-2xl md:text-4xl font-cascadia mb-5 text-black">
        Data Scientists<span className='p-0 m-0 font-semibold font-sans text-2xl'>_</span>
      </div>
